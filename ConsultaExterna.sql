...
CREATE TABLE IF NOT EXISTS `SCE_POSEC`.`recetas_medicamentos` (
  ...
  `recmed_id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `SCE_POSEC`.`citas` (
  ...
  `cit_pr_rfc` VARCHAR(13) NOT NULL,
  PRIMARY KEY (`cit_id`),
  INDEX `fk_citas_pacientes1_idx` (`cit_num_seguro_paciente` ASC),
  INDEX `fk_citas_personal1_idx` (`cit_pr_rfc` ASC),
...
-- -----------------------------------------------------
-- Table `SCE_POSEC`.`sesiones`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SCE_POSEC`.`sesiones` ;

CREATE TABLE IF NOT EXISTS `SCE_POSEC`.`sesiones` (
